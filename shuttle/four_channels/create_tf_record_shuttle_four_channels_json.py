...
flags = tf.app.flags
flags.DEFINE_string('labeled_path', '/media/seten/Datos/diego/TFM/dataset_tfm/shuttlecock/secuencias/test', 'Path where labeled images are')
flags.DEFINE_string('output_path', '/home/seten/TFM/data/test_shuttlecock_four_channels.record', 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', '/home/seten/TFM/data/shuttle_map.pbtxt','Path to label map proto')
FLAGS = flags.FLAGS

# TODO refactor este modulo
