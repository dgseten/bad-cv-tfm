...
def find_points():
    img = cv2.imread('C:\\TFM\\ws1\\test_final_alg\\court_pattern.jpg')
    ...
    lines = cv2.HoughLines(thresh3, 1, np.pi / 180, 150)
...
def main():
    ...
    intersections = find_points()

    img = cv2.imread('C:\\TFM\\ws1\\test_final_alg\\court_pattern.jpg')

    # TODO temporal draw intersections
    for intersection in intersections:
        cv2.circle(img, intersection, 2, (0, 0, 255), -1)
